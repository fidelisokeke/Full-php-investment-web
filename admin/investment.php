...
<head>
    ...
    <title>FlyTrade Admin: Bitcoin & Cryptocurrency trading Dashboard</title>
        ...
        <div class="page-sidebar fixedscroll">
            ...
            <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                ...
                <ul class='wraplist'>
                    ...
                    <li class="">
                        <a class="" href="delete_user.php">
                            <i class="fa fa-trash"></i>
                            <span class="title">Delete User</span>
                        </a>
                    </li>
                    <li class="open">
                        <a class="active" href="investment.php">
                            <i class="fa fa-money"></i>
                            <span class="title">Investment Table</span>
                        </a>
                    </li>
...
<table class="table table-bordered table-hover">
                            <h1 class="title">INVESTMENT TABLE</h1>

                            <thead class="thead-dark"> 
                                <tr>
                                    <th> ID</th>
                                    <th> Total Investment</th>
                                    <th>Unconfirmed Investment</th>
                                    <th>Total Profit</th>
                            ...
                            <?php
                                  ...
                                  while ($row = mysqli_fetch_assoc($select_investment)){
                                    ...
                                    $total_profit = $row['total_profit'];
                                          ...
                                          echo "<tr>";
                                          echo "<td>{$total_investment}</td>";
                                          echo "<td>{$unconfirmed_investment}</td>";
                                          echo "<td>{$total_profit}</td>";
                                          echo "<td> <a  href='admin.php?source=edit_investment' class = 'btn btn-primary'>edit</a></td>";
                                          echo "</tr>";
